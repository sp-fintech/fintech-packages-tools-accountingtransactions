...
namespace Apps\Fintech\Packages\Accounting\Transactions\Install;

use Apps\Fintech\Packages\Accounting\Transactions\Install\Schema\AccountingTransactions;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_fintech_accounting_transactions'  => [
                    'schema'        => new AccountingTransactions,
                    'model'         => new AppsFintechAccountingTransactions
                ]
            ];
